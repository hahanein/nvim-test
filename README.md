...
* A single execution environments ("[strategies](#strategies)")
...
Test.vim can run tests using only a single execution environment called
"strategy". The only availabl strategy is "AsyncRun".
